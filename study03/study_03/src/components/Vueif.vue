...
<template>
  <div>
    ...
    <p v-if="isVisible">v-if: 조건이 true일 때만 표시 (조건이 false이면) DOM에서 완전히 제거됨</p>
    <p v-show="isVisible">
      v-show: 조건에 따라 보이기만 함 (조건이 false여도 DOM에서 남아있지만 display :none으로 숨김)
    </p>
    <hr />
    <div class="if">
    ...
    <div class="container">
      ...
      <button :class="{ reserveBtn: isAvailable, disableBtn: !isAvailable }" @click="isAvailable = !isAvailable">
